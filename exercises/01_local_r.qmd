...
2. Try and install R locally using a linux container. This can work, but only reliably for Chromebooks that use an Intel/AMD CPU (not an ARM CPU). Ask if you are unsure.
...
![A screenshot of a new RStudio installation on macOS.](assets/rstudio_3.png)